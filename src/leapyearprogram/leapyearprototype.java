 ...
 * @author Asus
 */
public class leapyearprototype extends javax.swing.JFrame {

    /**
     * Creates new form leapyearprototype
     */
    public leapyearprototype() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(y%400==0) 
        { 
            l1.setText("Its a Leap Year"); 
        } 
        else if(y%100==0) 
        { 
            l1.setText("Its not a Leap Year");
        } 
        else if(y%4==0) 
        { 
            l1.setText("Its a Leap Year");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(leapyearprototype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new leapyearprototype().setVisible(true);
            }
        });
    }
